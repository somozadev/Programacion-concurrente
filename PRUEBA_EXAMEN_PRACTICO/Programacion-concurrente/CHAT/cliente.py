...
class Cliente():
	...
	def __init__(self, host= input("Escriba la IP: "), port= input("Escriba el puerto: ")):
		...
		self.enviar("Pc name:", os.environ['COMPUTERNAME'], "\n", "Pc nucleos virtuales:",os.cpu_count(), "\n", "Pc nucleos físicos: ",os.cpu_count()/2,"\n","Pc ram: ", ((os.sysconf('SC_PAGE_SIZE') * os.sysconf('SC_PHYS_PAGES'))/(1024.**3)))
